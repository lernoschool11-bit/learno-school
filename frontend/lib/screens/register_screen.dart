...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  final _nationalIdController = TextEditingController(); // اختياري
  ...
  String? _validatePage1() {
    ...
    // الرقم الوطني اختياري - بس إذا أدخله لازم يكون 10 أرقام
  ...
  String? _validatePage2() {
    if (_schoolController.text.trim().isEmpty) return 'الرجاء إدخال اسم المدرسة';
  ...
  Future<void> _register() async {
    ...
    if (success) {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('فشل التسجيل. قد تكون المعلومات مستخدمة مسبقاً.'),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildField(_dobController, 'تاريخ الميلاد *', Icons.calendar_today,
              hint: '2000-01-01'),
          const SizedBox(height: 16),
  ...
  Widget _buildPage2() {
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          _buildField(_schoolController, 'اسم المدرسة *', Icons.school),
          const SizedBox(height: 20),
            ...
            Wrap(
              ...
              children: _grades.map((grade) => ChoiceChip(
                ...
                labelStyle: TextStyle(
                  color: _selectedGrade == grade ? Colors.white : Colors.black,
                ),
            ...
            Row(
              children: _sections.map((section) => Padding(
                ...
                child: ChoiceChip(
                  ...
                  selectedColor: const Color(0xFF0A2342),
                  labelStyle: TextStyle(
                    color: _selectedSection == section ? Colors.white : Colors.black,
                  ),
  ...
  Widget _buildRoleButton(String role, String label, IconData icon) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: selected ? const Color(0xFF0A2342) : Colors.grey.shade200,
  ...
  Widget _buildField(TextEditingController controller, String label, IconData icon,
      {TextInputType keyboardType = TextInputType.text, bool obscure = false, String? hint}) {
